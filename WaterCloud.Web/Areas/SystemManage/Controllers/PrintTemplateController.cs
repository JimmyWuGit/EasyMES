...
namespace WaterCloud.Web.Areas.SystemManage.Controllers
{
    ...
    public class PrintTemplateController :  ControllerBase
    {
        ...
        public async Task<ActionResult> GetGridJson(SoulPage<PrintTemplateEntity> pagination, string keyword)
        {
        ...
        [HttpPost]
        [HandlerAjaxOnly]
        public async Task<ActionResult> SubmitForm(PrintTemplateEntity entity, string keyValue)
        {
            try
            {
