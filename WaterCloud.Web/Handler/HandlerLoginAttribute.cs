...
namespace WaterCloud.Web
{
	public class HandlerLoginAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (current == null && boardCurrent == null)
            {
            ...
            {
                //检测有没有看板特性
                var board = description.ControllerTypeInfo.GetCustomAttribute(typeof(HandlerBoardAttribute));
                var methodboard = description.MethodInfo.GetCustomAttribute(typeof(HandlerBoardAttribute));
                if (board == null && methodboard == null)
                {
                    //清除看板登录信息
