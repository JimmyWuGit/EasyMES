...
CREATE TABLE [dbo].[mes_EqpMaterialBanding] (
  ...
  [F_Priority] int  NOT NULL,
  [F_PrgName] nvarchar(100) COLLATE Chinese_PRC_CI_AS  NULL
)
GO
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[mes_LaserlineData]') AND type IN ('U'))
	DROP TABLE [dbo].[mes_LaserlineData]
GO

CREATE TABLE [dbo].[mes_LaserlineData] (
  [F_Id] bigint  IDENTITY(1,1) NOT NULL,
  [F_EqpId] nvarchar(50) COLLATE Chinese_PRC_CI_AS  NOT NULL,
  [F_AddTime] datetime2(7)  NULL,
  ...
  [F_DeleteTime] datetime2(7)  NULL,
  [F_DeleteUserId] nvarchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [F_PrgName] nvarchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [F_RunTime] int DEFAULT 0 NULL,
  [F_ClassPiece] int  NULL,
  [F_StationNo] int  NULL
)
GO

ALTER TABLE [dbo].[mes_LaserlineData] SET (LOCK_ESCALATION = TABLE)
GO

EXEC sp_addextendedproperty
'MS_Description', N'主键-自增',
'SCHEMA', N'dbo',
'TABLE', N'mes_LaserlineData',
'COLUMN', N'F_Id'
GO
...
EXEC sp_addextendedproperty
'MS_Description', N'切割序号',
'SCHEMA', N'dbo',
'TABLE', N'mes_LaserlineData',
'COLUMN', N'F_ClassPiece'
GO

EXEC sp_addextendedproperty
'MS_Description', N'转台号',
'SCHEMA', N'dbo',
'TABLE', N'mes_LaserlineData',
'COLUMN', N'F_StationNo'
GO
...
-- ----------------------------
SET IDENTITY_INSERT [dbo].[mes_LaserlineData] ON
GO

SET IDENTITY_INSERT [dbo].[mes_LaserlineData] OFF
GO
...
CREATE TABLE [dbo].[mes_OutputInfo] (
  ...
  [F_BandingTime] datetime2(7)  NULL,
  [F_IsTemp] tinyint DEFAULT 0 NULL,
  [F_GoOnProduce] nvarchar(20) COLLATE Chinese_PRC_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[mes_Storage] (
  ...
  [F_BatchId] nvarchar(50) COLLATE Chinese_PRC_CI_AS DEFAULT '' NOT NULL
)
GO
...
-- ----------------------------
-- Auto increment value for mes_LaserlineData
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[mes_LaserlineData]', RESEED, 1155867)
GO


-- ----------------------------
-- Primary Key structure for table mes_LaserlineData
-- ----------------------------
ALTER TABLE [dbo].[mes_LaserlineData] ADD CONSTRAINT [PK__mes_Lase__2C6EC723F546DF89] PRIMARY KEY CLUSTERED ([F_Id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
